...
| DD-017 Equilibrium Selection and Coalition Stability | active on issue #103 | Pure, symmetric-mixed, and coalition-stability objects are separate; the bounded exact registry must pass a clean immutable run before any claim. |
