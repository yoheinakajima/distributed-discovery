...
| DiscoveryBench v3 | active registered extension on issue #116 | Preserve v1/v2 defaults and exact vectors; add four Program V4 tasks with capability isolation, 36 compatible exact rows, 660 exclusions, and no composite score. |
