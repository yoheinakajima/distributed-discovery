...
| DD-021 General Sharing Frontier | registered on issue #146; proof and source development active | Keep sharing-curve, full-consensus, and action-budget recovery classifications separate; no run or claim exists before the clean-source gate. |
