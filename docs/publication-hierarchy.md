...
2. **Flagship theorem-family working papers.** *The Common-Source Trap*,
   *The Incentive to Ignore*, *Threshold Discovery*, and *When Does
   ...
   arguments. They remain working papers and are subject to literature and
   evidence audit.
3. **Notes and syntheses.** *Foundations*, *Three Results*, and *Discovery
   Institutions* explain or connect work whose primary ownership remains with
   claims, studies, and theorem-family papers.
4. **Evidence and infrastructure.** Registered studies, immutable runs,
   certificates, the claim ledger, DiscoveryBench, Labs, schemas, validators,
   and public data expose the evidence boundary.
