...
| DD-002 | Information Design for Discovery | complete bounded selection catalogue | Preserve six-rule regressions; randomized disclosure deferred |
...
| DD-010 | TreasureBench (historical identifier DiscoveryBench) | complete bounded study and registered Agents v1 instrument | Preserve v1–v3 exact evidence and both quarantined engineering pilots; next candidate is a separately registered public-only provider-schema conformance gate; DD-023 remains unallocated |
...
DD-018 has one passing immutable exact run supporting four verified bounded
