...
| DD-001 | Distributed Discovery with Private Information | registered | Exact evaluator and tiny exhaustive cases |
...
Each directory contains its question, model, plan, claims view, status, results index, and report. DD-001 becomes active after DD-000 foundations milestones are complete.
