...
The M9 acceptance reproduction is `baseline/20260720T202314Z_DD-000_88613408_217c602fa0`; it started from a clean research commit and passed upstream plus independent checks. Claim records continue to cite their originally audited run IDs. DD-001 exact tiny-grid, bounded canonical-search, and lossless signature-reduction runs are under [`verified/`](verified/README.md); each run's manifest distinguishes certified outputs, state-space certificates, and heuristic lower bounds.

Milestone A changed public licensing, deployment, and GitHub organization only. DD-001A then added a primary immutable run and claims DD-C-0023 through DD-C-0025 without altering earlier provenance.
