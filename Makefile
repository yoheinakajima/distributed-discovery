...
treasurebench-provider-schema-conformance-audit:
	...
	$(RUN) pytest -q tests/unit/test_treasurebench_provider_schema_conformance.py tests/test_agents_v1_live_providers.py
