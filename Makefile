...
OWNER_GATE_CHALLENGE ?=
OWNER_GATE_VALIDATE_ONLY ?=
...
owner-gate:
	$(PY) -m distributed_discovery.cli agent-ops owner-gate --gate $(GATE) $(if $(OWNER_GATE_CHALLENGE),--challenge "$(OWNER_GATE_CHALLENGE)") $(if $(OWNER_GATE_VALIDATE_ONLY),--validate-only)

treasurebench-fresh-pilot-audit:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot.py

treasurebench-fresh-pilot-rehearsal:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot.py --rehearsal

treasurebench-fresh-pilot-live:
	$(PY) -m distributed_discovery.cli treasurebench fresh-pilot-live

treasurebench-fresh-pilot-v2-audit:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot_v2.py

treasurebench-fresh-pilot-v2-rehearsal:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot_v2.py --rehearsal

treasurebench-fresh-pilot-v2-live:
	$(PY) -m distributed_discovery.cli treasurebench fresh-pilot-v2-live

treasurebench-fresh-pilot-v3-audit:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot_v3.py

treasurebench-fresh-pilot-v3-rehearsal:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot_v3.py --rehearsal

treasurebench-fresh-pilot-v3-live:
	$(PY) -m distributed_discovery.cli treasurebench fresh-pilot-v3-live

treasurebench-fresh-pilot-v4-audit:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot_v4.py

treasurebench-fresh-pilot-v4-rehearsal:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot_v4.py --rehearsal

treasurebench-fresh-pilot-v4-live:
	$(PY) -m distributed_discovery.cli treasurebench fresh-pilot-v4-live

treasurebench-fresh-pilot-v5-audit:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot_v5.py

treasurebench-fresh-pilot-v5-rehearsal:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot_v5.py --rehearsal

treasurebench-fresh-pilot-v5-live:
	$(PY) -m distributed_discovery.cli treasurebench fresh-pilot-v5-live

treasurebench-open-weight-runtime-audit:
	$(PY) scripts/audit_treasurebench_open_weight_cloud_runtime.py
	$(RUN) pytest -q tests/test_treasurebench_open_weight_cloud_runtime.py

treasurebench-open-weight-runtime-rehearsal:
	$(PY) scripts/audit_treasurebench_open_weight_cloud_runtime.py --rehearsal
...
treasurebench-open-weight-secret-cleanup-r6-audit:
	$(PY) -m distributed_discovery.benchmark.agents_v1.open_weight_cloud_runtime_r6 --rehearsal
	$(RUN) pytest -q tests/test_treasurebench_open_weight_cloud_runtime_r6.py

treasurebench-open-weight-secret-cleanup-r6-live:
	$(PY) -m distributed_discovery.benchmark.agents_v1.open_weight_cloud_runtime_r6 --live

treasurebench-open-weight-runtime-r7-audit:
	$(PY) -m distributed_discovery.benchmark.agents_v1.open_weight_cloud_runtime_r7 --rehearsal
	$(RUN) pytest -q tests/test_treasurebench_open_weight_cloud_runtime_r7.py

treasurebench-open-weight-runtime-r7-live:
	$(PY) -m distributed_discovery.benchmark.agents_v1.open_weight_cloud_runtime_r7 --live

treasurebench-custody-repair-audit:
	$(PY) scripts/audit_treasurebench_custody_repair.py

treasurebench-custody-live-conformance:
	$(PY) -m distributed_discovery.cli treasurebench custody-live-conformance

treasurebench-custody-read-only-diagnostic:
	$(PY) -m distributed_discovery.cli treasurebench custody-read-only-diagnostic

treasurebench-fixed-batch-diagnostic-audit:
	$(PY) scripts/audit_treasurebench_fixed_batch_diagnostic.py

treasurebench-fixed-batch-diagnostic-rehearsal:
	$(PY) scripts/audit_treasurebench_fixed_batch_diagnostic.py --rehearsal

treasurebench-fixed-batch-read-only-diagnostic:
	$(PY) -m distributed_discovery.cli treasurebench fixed-batch-read-only-diagnostic

treasurebench-fresh-pilot-closeout-audit:
	$(PY) scripts/audit_treasurebench_agents_v1_fresh_pilot_closeout.py
...
treasurebench-pilot-diagnostic-audit:
	$(PY) scripts/audit_treasurebench_pilot_diagnostic.py
...
common-source-trap-arxiv-package:
	$(PY) scripts/build_common_source_trap_arxiv_package.py --output-dir $(OUTPUT_DIR)
...
information-sharing-frontier-arxiv-package:
	$(PY) scripts/build_information_sharing_frontier_arxiv_package.py --output-dir $(OUTPUT_DIR)
