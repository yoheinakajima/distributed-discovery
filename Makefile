...
treasurebench-open-weight-runtime-rehearsal:
	...
	$(RUN) pytest -q tests/test_treasurebench_open_weight_cloud_runtime.py tests/test_treasurebench_open_weight_cloud_runtime_r2.py tests/test_treasurebench_open_weight_cloud_runtime_r3.py

treasurebench-open-weight-runtime-live:
	$(PY) -m distributed_discovery.benchmark.agents_v1.open_weight_cloud_runtime_r3 --live
