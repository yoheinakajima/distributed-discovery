# Research program integration — DD-004 through DD-007

The four bounded extensions are complete and public. DD-004 shows schedule-invariant terminal discovery under registered perfect elimination, with action/round tradeoffs. DD-005 gives exact overlap witnesses against top-individual and greedy portfolio rules. DD-006 finds weak truthful/direct implementation but no strict implementation in its nine score-difference mechanisms. DD-007 validates only synthetic records and retains both action-only and provenance-only nonidentification counterexamples.
