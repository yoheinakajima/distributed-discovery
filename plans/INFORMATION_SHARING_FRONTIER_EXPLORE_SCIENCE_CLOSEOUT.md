...
3. [ ] Add focused regressions and open one draft PR.
4. [ ] Apply the evidence-bounded manuscript/generator/disposition edits.
5. [ ] Build and extract-test the deterministic arXiv source package.
6. [ ] Rebuild twice, inspect every PDF page, and run focused/native checks.
