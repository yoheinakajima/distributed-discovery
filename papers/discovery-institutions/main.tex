...
\begin{center}\begin{tikzpicture}[node distance=5mm, every node/.style={draw,rounded corners,align=center,minimum width=19mm,minimum height=8mm}]
...
\input{generated/stack-evidence-table.tex}
