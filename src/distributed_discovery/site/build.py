...
def _benchmark_pages(root: Path, output: Path) -> dict[str, object]:
    ...
    agents_body = f"""
<header class="page-hero"><p class="eyebrow">DD-010 instrument · five quarantined pilots · protocol-validity policy v2</p><h1>DiscoveryBench Agents v1</h1><p class="lede">A complete instrument for studying how software-agent teams turn synthetic evidence into action portfolios. Its original sealed pilot and four repair-confirmation campaigns are permanently quarantined. AO-0010 freezes protocol-validity policy v2 and preserves the wholly fresh v4 provider-terminal quarantine. This is not a scientific evaluation or provider ranking.</p><p class="status-row"><span class="status-chip">Original pilot quarantined</span><span class="status-chip">Repair-confirmation v1 quarantined</span><span class="status-chip">Repair-confirmation v2 quarantined</span><span class="status-chip">Repair-confirmation v3 quarantined</span><span class="status-chip">Repair-confirmation v4 quarantined</span><span class="status-chip">Provider schemas passed</span><span class="status-chip">Custody path repaired</span><span class="status-chip">Policy v2 frozen</span></p></header>
...
"""
    ...
    agents_implementation_data = {
        ...
        "boundaries": {
            "provider_calls": agents_fresh_v4_closeout["executed"]["calls"],
            "model_invocations": agents_fresh_v4_closeout["executed"]["calls"],
            "model_downloads": 0,
            "network_calls": agents_fresh_v4_closeout["executed"]["calls"],
            "external_cost_usd": agents_fresh_v4_closeout["executed"]["cost_usd"],
        ...
        "campaign_registration": "complete-permanently-quarantined",
