...
<section class="content-section prose"><h2>Next open boundary</h2><p>The post-V5 audit recommends one unregistered bridge: Decentralized Recovery and Equilibrium Robustness. It asks when autonomous agents implement a posterior top-<code>L</code> portfolio across all, best, worst, refined, or dynamically selected equilibria. It creates no study or result and must clear a separate literature, model, resource, verification, and stop-condition gate.</p><p>Reliable Discovery and the Price of Missing Provenance remain later theorem programs. Reliability changes action technology; provenance changes what dependence is known. Neither is answered by Program V5.</p></section>
