...
def _benchmark_pages(root: Path, output: Path) -> dict[str, object]:
    ...
    agents_body = f"""
<header class="page-hero"><p class="eyebrow">DD-010 instrument · four quarantined pilots · prospective policy v2 · fresh v4 owner gate</p><h1>DiscoveryBench Agents v1</h1><p class="lede">A complete instrument for studying how software-agent teams turn synthetic evidence into action portfolios. Its original sealed pilot and three prior repair-confirmation campaigns are permanently quarantined. AO-0010 prospectively freezes protocol-validity policy v2 and prepares one wholly fresh v4 engineering pilot at an unconsumed owner gate. This is not a scientific evaluation or provider ranking.</p><p class="status-row"><span class="status-chip">Original pilot quarantined</span><span class="status-chip">Repair-confirmation v1 quarantined</span><span class="status-chip">Repair-confirmation v2 quarantined</span><span class="status-chip">Repair-confirmation v3 quarantined</span><span class="status-chip">Provider schemas passed</span><span class="status-chip">Custody path repaired</span><span class="status-chip">Policy v2 frozen</span><span class="status-chip">Fresh v4 owner gate required</span></p></header>
...
"""
    ...
    agents_implementation_data = {
        ...
        "next_gate": (
            "exact generic AO-0010 owner gate required before fresh v4 credentials, "
            "private generation, provider calls, spend, or unsealing"
        ),
    }
    _write(
        output,
